...
public class DropDownDemo1 extends BaseClass {
	...
	public static void main(String[] args) throws InterruptedException {
		// In properties file, uncomment Syntax Practice site URL 
		//code written for " http://166.62.36.207/syntaxpractice/basic-select-dropdown-demo.html"
		...
		/*
		 * Selenium provides three different ways to select a value from a DD. 1. 1.
		 * byIndex(); 2. ByVisibleText(String str); 3. ByValue();
		 */
